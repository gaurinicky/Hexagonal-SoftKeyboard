...
import ca.yorku.eecs.mack.softkeyboardgauri9.KeyboardPanel.OnKeystrokeListener;

public class SoftKeyboardgauri9Activity extends Activity implements OnKeystrokeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        switch (keyboardLayout)
        {
            ...
            case "Metropolis":
                ...
                break;
            case "ThumbLand":
                keyboard.loadKeyboardFromResource(R.array.myown, scalingFactor);
                break;
            case "Atomik":
                keyboard.loadKeyboardFromResource(R.array.atomik, scalingFactor);
                break;
            case "ThumbPortrait":
                keyboard.loadKeyboardFromResource(R.array.myown2, scalingFactor);
                break;
        }
